...
"$HOME\.dsh\.agent-presets\lite"内新建一个模式，仓库agent-pcordis.yaml是带调用overlay.mjs的标准模式，你可以在overlay.mjs中修改提示词。如果要删工具overlay.mjs和cordis.yml要一起删或者直接让ai改。如果想修改DSH的其他模式，让ai读md。 
## 用法
